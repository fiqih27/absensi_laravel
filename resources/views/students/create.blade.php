                ...
                <form action="{{ route('students.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('fingerprint_uid') is-invalid @enderror"
                               id="fingerprint_uid" name="fingerprint_uid" value="{{ old('fingerprint_uid') }}">
                        <small class="text-muted">UID dari mesin fingerprint (opsional)</small>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('device_user_id') is-invalid @enderror"
                               id="device_user_id" name="device_user_id" value="{{ old('device_user_id') }}">
                        <small class="text-muted">User ID di mesin ZKTeco (opsional)</small>
